...
export const messageDataSchema = Type.Pick(messageSchema, ['timestamp', 'message', 'authorId', 'authorName', 'authorAvatar', 'image', 'attachment', 'audio'], {
  $id: 'MessageData'
})
...
export const messageQueryProperties = Type.Pick(messageSchema, ['_id'])
